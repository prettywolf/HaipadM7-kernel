...
*/
#ifndef _HDMI_TV_OUT_S5PV210_H_
#define _HDMI_TV_OUT_S5PV210_H_

#include <linux/i2c.h>

/* #define S5P_HDCP_DEBUG */
/* #define S5P_HDCP_I2C_DEBUG */
/* #define S5P_HDCP_AUTH_DEBUG */
/* #define S5P_HDMI_DEBUG */
/* #define S5P_SDAOUT_DEBUG */
/* #define S5P_TVOUT_PM_DEBUG */
/* #define S5P_MXR_DEBUG */
/* #define S5P_VP_DEBUG */

#define HDMI_START_NUM 0x1000

#define HDMI_TIME_OUT (100)
...
enum s5p_sd_order {
	S5P_TV_SD_O_ORDER_COMPONENT_RGB_PRYPB = 0,
...
enum s5p_vp_pxl_rate {
	...
	VPROC_PIXEL_PER_RATE_1_2,
	VPROC_PIXEL_PER_RATE_1_3,
	VPROC_PIXEL_PER_RATE_1_4,
};
...
enum s5p_vp_filed_id_toggle {
	S5P_TV_VP_FILED_ID_TOGGLE_USER = 0,
...
enum s5p_sd_level {
	S5P_TV_SD_LEVEL_0IRE = 0,
	S5P_TV_SD_LEVEL_75IRE
};

enum s5p_sd_vsync_ratio {
	SDOUT_VTOS_RATIO_10_4 = 0,
...
enum s5p_tv_hdmi_disp_mode {
	...
	S5P_TV_HDMI_DISP_MODE_576P_50,
	S5P_TV_HDMI_DISP_MODE_720P_60,
	S5P_TV_HDMI_DISP_MODE_720P_50,
	S5P_TV_HDMI_DISP_MODE_1080I_60,
	S5P_TV_HDMI_DISP_MODE_1080I_50,
	S5P_TV_HDMI_DISP_MODE_VGA_60,
	S5P_TV_HDMI_DISP_MODE_1080P_60,
	S5P_TV_HDMI_DISP_MODE_1080P_50,
	S5P_TV_HDMI_DISP_MODE_NUM
};

/* pixel aspect ratio for HDMI HW (AVI packet and EDID) */
enum s5p_tv_hdmi_pxl_aspect {
    HDMI_PIXEL_RATIO_4_3 = 0,
...
enum s5p_tv_hdmi_interrrupt {
	...
	HDMI_IRQ_I2S,
	HDMI_IRQ_GLOBAL,
	HDMI_IRQ_PIN_POLAR_CTL,
};

typedef int (*hdmi_isr)(int irq);

extern void __iomem *g_hdmi_base;

/* 0 - hdcp stopped, 1 - hdcp started, 2 - hdcp reset */
extern u8 g_hdcp_protocol_status;

#endif /* _HDMI_TV_OUT_S5PV210_H_ */
